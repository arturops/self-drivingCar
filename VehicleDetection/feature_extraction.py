...
def get_hog_features(img, orient, pix_per_cell, cell_per_block, 
    ...
    """ 
    Computes HOG features and visualization if vis is True
    """
...
def color_hist(img, nbins=32, bins_range=(0, 256), vis_ret=False):
    """ 
    Computes color histogram features. Note that
    bins_range is (0, 256) if .jpg. Otherwise, (0,1) if reading .png files with mpimg!
    """
    ...
    if vis_ret:
        # Return separately all channels and the bins centers
...
def draw_boxes(img, bboxes, color=(0, 0, 255), thick=6, random_color=False):
    """ 
    Draws in the bounding boxes bboxes in image img
    """
...
#-------------- Additional Functions not used in the pipeline, but in the notebook ---------------
