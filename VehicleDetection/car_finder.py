...
def load_svm_info():
    ...
    hist_bins, spatial_feat, hist_feat, hog_feat, y_start_stop, svc, X_scaler
...
def find_cars(img, color_space, orient, pix_per_cell, cell_per_block, hog_channel, 
                spatial_size, hist_bins, spatial_feat, hist_feat, hog_feat,
                 y_start_stop, svc, X_scaler, scale =[1.5], heat_frames = 5,
                 confidence_threshold = 0.3, heat_threshold = 2, window_size = 64):
...
def car_detection(img, scale =[1.1, 1.5, 1.9, 2.3],  heat_frames = 5, confidence_threshold = 0.3,
                    heat_threshold = 2, window_size = 64):    
    # Recover values used for SVM training setup and results
    color_space, orient, pix_per_cell, cell_per_block, hog_channel, spatial_size,\
    hist_bins, spatial_feat, hist_feat, hog_feat, y_start_stop, svc, X_scaler = load_svm_info()
    ...
    result_img = find_cars(img, color_space, orient, pix_per_cell, cell_per_block, hog_channel, 
                            spatial_size, hist_bins, spatial_feat, hist_feat, hog_feat,
                            y_start_stop, svc, X_scaler, scale, heat_frames,
                            confidence_threshold, heat_threshold, window_size)
