...
def load_dataset():
    """
    Load the images from vehicles and non-vehicles dataset
    """
...
def vehicle_classifier(color_space = 'YCrCb', # Can be RGB, HSV, LUV, HLS, YUV, YCrCb
                        ...
                        y_start_stop = [400, 660], #400,None Min and max in y to search in slide_window()
                        return_svm = False):
...
if __name__ == '__main__':
    ...
    vehicle_classifier(color_space, orient, pix_per_cell, cell_per_block, hog_channel,
                        spatial_size, hist_bins, spatial_feat, hist_feat, hog_feat, y_start_stop)
